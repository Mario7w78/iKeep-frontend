 ...
 *
 * El "se esconde solo y no vuelve por una semana" vive en el hook, compartido
 * con el banner del Home, para que los dos avisos no se pisen.
 */
export const GoogleCalendarCta: React.FC = () => {
  ...
  const visible = useAvisoGoogleCalendar();
